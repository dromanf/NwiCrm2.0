...
<html lang="es">
  <head>
    ...
    <title>Tabla de convocados - Niwali CRM</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Convocados</h4>
                    ...
                    <tbody>
                      <?php 
                      $sql= "SELECT * from db_human_talent where Status='Convocado'";
                      ...
                      <td class="py-1"><?php echo $mostrar['Phone_Cell'] ?></td>
                      <td class="py-1"><?php echo $mostrar['Recruiter']; ?></td>
                      <td class="py-1"><?php
                        echo '<a href="../../actions/action_edit_user_1_con.php?nik='.$mostrar['ID'].'" title="Editar datos" class="btn btn-primary btn-sm"><i class="fa-pencil-square-o" style="color: whithe;"></i></a>';
                      }                      
                      ?>
