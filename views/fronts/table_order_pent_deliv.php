...
<html lang="es">
  <head>
    ...
    <title>Ventas enviadas - Niwali CRM</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Ventas enviadas</h4>
            ...
            <tr>
              ...
              <th>Acciones</th>
                      ...
                      <tbody>
                        ...
                        <td><?php
                        echo '<a href="../../actions/action_edit_order_send.php?nik='.$mostrar['id'].'" title="Editar datos" class="btn btn-primary btn-sm"><i class="far fa-edit"></i></a>';
                        }
                        ?>
                        </td>
                        </tr>
