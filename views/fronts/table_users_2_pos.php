              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <tbody>
                      <?php 
                      $sql= "SELECT * from db_human_talent where Status='Postulante'";
                      ...
                      <td class="py-1"><?php
                        echo '<a href="../../actions/action_edit_user_2_pos.php?nik='.$mostrar['ID'].'" title="Editar datos" class="btn btn-primary btn-sm"><i class="fa-pencil-square-o" style="color: whithe;"></i></a>';
                      }                      
                      ?>
