...
<html lang="es">
  <head>
    ...
    <title>Ventas liquidadas - Niwali CRM</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Ventas liquidadas</h4>
                    ...
                    <thead>
                      ...
                      <tbody>
                      <?php 
                    $sql= "SELECT * from db_sales where status = 'Pendiente_Reclamo_Pago' ORDER BY date_add ASC";
