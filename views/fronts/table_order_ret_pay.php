          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <thead>
                      ...
                      <tbody>
                      <?php 
                $sql= "SELECT * from db_sales where status = 'Pte_Retorno_Cobrado' ORDER BY date_add ASC";
                ...
                <td><?php
                echo '<a href="../actions/action-edit-order-ret-pay.php?nik='.$mostrar['id'].'" title="Editar datos" class="btn btn-primary btn-sm"><i class="far fa-edit"></i></a>';
                }
                ?>
                        <td><a href="https://tools.usps.com/go/TrackConfirmAction.action?tLabels=<?php echo $mostrar ['tracking_number']; ?>" target="blank"><?php echo $mostrar ['tracking_number']; ?></a></td>
                        </tr>
