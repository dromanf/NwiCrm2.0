...
<html lang="es">
  <head>
    ...
    <title>Ventas entregadas - Niwali CRM</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Ventas entregadas</h4>
                    ...
                    <thead>
                      ...
                      <tbody>
                        <?php 
                        $sql= "SELECT * from db_sales where status = 'Entregada' ORDER BY date_add ASC";
                        ...
                        <td><?php
                        echo '<a href="../../actions/action_edit_order_deliv.php?nik='.$mostrar['id'].'" title="Editar datos" class="btn btn-primary btn-sm"><i class="far fa-edit"></i></a>';
                        }
                        ?>
                        </td>
                        </tr>
