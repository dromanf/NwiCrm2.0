...
<html lang="es">
  <head>
    ...
    <title>Ventas con el pago confirmado - Niwali CRM</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Ventas con el pago confirmado</h4>
                    ...
                    <thead>
                      ...
                      <tbody>
                        <?php 
                        $sql= "SELECT * from db_sales where status = 'Pago_Confirmado' ORDER BY date_add ASC";
                        ...
                        <td><?php
                        echo '<a href="../../actions/action_edit_order_paid.php?nik='.$mostrar['id'].'" title="Editar datos" class="btn btn-primary btn-sm"><i class="far fa-edit"></i></a>';}
                        ?>
                        </td>
                        </tr>
                      </tbody>
