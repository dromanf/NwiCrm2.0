...
<html lang="es">
  <head>
    ...
    <title>Ventas validadas - Niwali CRM</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Ventas validadas</h4>
                    ...
                    <thead>
                      ...
                      <tbody>
                        <?php 
                        $sql= "SELECT * from db_sales where status = 'Validada' ORDER BY date_add ASC";
                        ...
                        <td><?php
                        echo '<a href=".../action_edit_order_shippy.php?nik='.$mostrar['id'].'" title="Enviar orden" class="btn btn-success btn-sm"><i class="far fa-edit"></i></a>';
                        echo '<a href="../actions/action_edit_order_shippm.php?nik='.$mostrar['id'].'" title="Editar datos" class="btn btn-primary btn-sm"><i class="far fa-edit"></i></a>';
                        }
                        ?>
                        </td>
                        </tr>
