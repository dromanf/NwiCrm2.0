...
<html lang="es">
  <head>
    ...
    <title>Tabla de personal activo (Administrativo) - Niwali CRM</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Primera linea (Administrativo)</h4>
                    ...
                    <tbody>
                      <?php 
                      $sql= "SELECT * from db_user_act where Personal_Type='Administrativo'";
                      ...
                      <td class="py-1"><?php echo $mostrar['Name'] ?></td>
                      <td class="py-1"><?php echo $mostrar['Lastname_Paternal'] ?></td>
                      <td class="py-1"><?php echo $mostrar['Lastname_Maternal'] ?></td>
                      <td class="py-1"><?php echo $mostrar['CI'] ?></td>
                      <td class="py-1"><?php echo $mostrar['Status'] ?></td>
                      <td class="py-1"><?php echo $mostrar['Recruiter']; ?></td>
                      <td class="py-1"><?php
                        echo '<a href="../../actions/action_edit_user_act_ase.php?nik='.$mostrar['ID'].'" title="Editar datos" class="btn btn-primary btn-sm"><i class="fa-pencil-square-o" style="color: whithe;"></i></a>';
                      }                      
                      ?>
