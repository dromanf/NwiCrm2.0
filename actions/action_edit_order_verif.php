...
<?php		
			...
			if(mysqli_num_rows($sql) == 0){
				//header("Location: ../views/index-table-order-alert.php");
			}else{
        ...
        $update = mysqli_query($connect, "UPDATE db_sales SET name_client='$nameClient', lastname_client='$lastNameClient', phone='$phone', phone_alt='$phoneAlt', gender='$genClient', age='$ageClient', address='$direccion', zip_code='$zipcode', zip_4='$zipfour', city='$city', state='$state', payment_type='$payment', procesadora='$cardProcess', coment_payment='$comentPayment', price='$price', re_order='$reOrder', coment='$coment', product1='$productOne',  qty1='$qtyOne', product2='$productTwo', qty2='$qtyTwo', product3='$productThree', qty3='$qtyThree', product4='$productFour', qty4='$qtyFour', product5='$productFive', qty5='$qtyFive', date_edit='$fechaEdit', status='$status', date_verif='$fechaEdit', verif_for='$usuarioModif' WHERE id='$nik'") or die(mysqli_error());
        if($update){
    ...
    if(isset($_POST['modificate'])){
      $agente	 			= mysqli_real_escape_string($connect,(strip_tags($_POST["agente"],ENT_QUOTES)));//Escanpando caracteres 
        ...
        if($update){
          header("Location: action_edit_order_verif.php?nik=".$nik."&pesan=sukses");
        }else{
          echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Error, no se pudo guardar los datos.</div>';
        }
      }	
            ...
            <div class="col-lg-4 mx-auto">
              ...
              <div class="auto-form-wrapper">
                <form id="submitUsertForm" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                    <textarea type="text" name="comentPaymentOld" style="height: 50px;" class="form-control" readonly="readonly"><?php echo $row ['coment_payment']; ?></textarea>
                      <div class="input-group-append">
                        <span class="input-group-text">
                          <i class="mdi mdi-check-circle-outline"></i>
                        </span>
                  ...
                  <div class="form-group">
                  <input type="submit" name="etiquetar" class="btn btn-sm btn-success" value="Verificar">
						<input type="submit" name="postfechate" class="btn btn-sm btn-secondary" value="Post-Fechar">
						<input type="submit" name="modificate" class="btn btn-sm btn-primary" value="Guardar">
						<input type="submit" name="cancelate" class="btn btn-sm btn-danger" value="Cancelar">
