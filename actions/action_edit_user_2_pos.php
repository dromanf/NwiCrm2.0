...
<html lang="es">
  ...
  if(mysqli_num_rows($sql) == 0){
	var_dump($sql);
	die();
	  header("Location: ../views/fronts/table_users_pos.php");
  }else{
            ...
            <div class="col-lg-4 mx-auto">
              ...
              <div class="auto-form-wrapper">
                <form id="submitUsertForm" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
				            <input type="submit" name="etiquetar" class="btn btn-success submit-btn btn-block" value="Pasar Aspirante">						
                  ...
                  <div class="text-block text-center my-3">
                    ...
                    <a href="../views/fronts/table_users_2_pos.php" class="text-black text-small">Regresar</a>
                  </div>
                </form>
              </div>
            </div>
